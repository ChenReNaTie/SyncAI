...
export interface AgentRuntimeInfoResponse {
...
export interface AgentConfigState {
  selected: AgentSessionConfig;
  runtime: AgentRuntimeInfo | null;
  options: AgentConfigOptions;
}

export interface AgentConfigStateResponse {
  data: AgentConfigState | null;
}
...
export function getSessionAgentContext(
  token: string,
  sessionId: string,
): Promise<AgentRuntimeInfoResponse> {
  return request<AgentRuntimeInfoResponse>(`/sessions/${sessionId}/agent-context`, {
    headers: { Authorization: `Bearer ${token}` },
  });
}

export function getSessionAgentConfig(
  token: string,
  sessionId: string,
): Promise<AgentConfigStateResponse> {
  return request<AgentConfigStateResponse>(`/sessions/${sessionId}/agent-config`, {
    headers: { Authorization: `Bearer ${token}` },
  });
}
